<a href="{{ route('supplier_manager.orders') }}" class="mt-10 col-md-3 col-sm-12 bg-white px-6 py-8 rounded-xl  d-flex justify-content-between align-items-center">
    <div class="">
        ...
        <span  class="text-success font-weight-bold font-size-h6 mt-2">{{__("عدد الطلبات")}}</span>
    </div>
    <div class="d-flex flex-column">
        <span class="font-weight-bolder font-size-h1">{{ $orders_count }} </span>
