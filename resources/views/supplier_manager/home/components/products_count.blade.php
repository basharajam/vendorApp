<a href="{{ route('supplier_manager.suppliers.all_products') }}" class="mt-10 col-md-3 col-sm-12 bg-white px-6 py-8 rounded-xl  d-flex justify-content-between align-items-center">
    <div class="">
        <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-2 text-center"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-12-10-081610/theme/html/demo2/dist/../src/media/svg/icons/Cooking/Kitchen-scale.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
        ...
        <span  class="text-danger font-weight-bold font-size-h6 mt-2">{{__("عدد المنتجات")}}</span>
    </div>
    <div class="d-flex flex-column">
        <span class="font-weight-bolder font-size-h1">{{ $products_count }} </span>
