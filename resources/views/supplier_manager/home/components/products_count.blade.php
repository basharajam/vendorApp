<a href="{{ route('supplier_manager.suppliers.all_products') }}" class=" col-md-3 col-sm-12 bg-white px-6 py-8 rounded-xl  d-flex justify-content-between align-items-center">
    <div class="">
