        ...
        <div class="kt-header-menu-wrapper d-flex justify-content-center" id="kt_header_menu_wrapper">
            <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right" style="direction:rlt;">
                <ul class="kt-menu__nav">
                    ...
                    <li class="kt-menu__item kt-menu__item--rel {{ (Route::currentRouteName()  == 'supplier.tags') ? ' kt-menu__item--active' : '' }} kt-menu__item--open" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="{{ route('supplier.properties') }}"  class="kt-menu__link "><span class="kt-menu__link-text">{{__("properties")}}</span><i class=""></i></a></li>
