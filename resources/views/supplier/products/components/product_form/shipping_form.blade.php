...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <input data-inputmask="'regex': '^[0-9]+$'" id="days_to_delivery" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6 @error('days_to_delivery') is-invalid @enderror" type="text" placeholder="0" name="days_to_delivery" value="{{ array_key_exists('days_to_delivery',$meta ) ? $meta['days_to_delivery']  :  old('days_to_delivery') }}" required  />
