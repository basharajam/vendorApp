<div class="row m-0 statsitcs-container">
    <a href="{{ route('supplier.not_paid_orders') }}" class=" col-md-5 col-sm-12 bg-white px-6 py-8 rounded-xl  d-flex justify-content-between align-items-center">
        <div class="">
    ...
    <a href="{{ route('supplier.paid_orders') }}" class="col-md-5 col-sm-12 bg-white px-6 py-8 rounded-xl d-flex justify-content-between align-items-center statsitcs-second-item" >
        <div>
